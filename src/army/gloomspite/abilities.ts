import { MORALE_PHASE, END_OF_TURN, TURN_ONE_START_OF_TURN, START_OF_TURN } from 'types/phases'
...
const Abilities: IEffects[] = [
  {
    ...
    desc: 'GLOOMSPITE GITZ units wholly within 12" of the Bad Moon Loonshrine do not take MORALE tests.',
    when: MORALE_PHASE,
  },
  {
