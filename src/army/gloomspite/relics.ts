    ...
    effects: [
      {
        name: 'Moonface Mommet',
        desc:
          'At the start of the FIGHT phase, pick 1 enemy unit within 12" of the bearer. Subtract 1 from save rolls for attacks that target that unit until the end of the phase.',
        when: START_OF_FIGHT_PHASE,
      },
    ],
  },
    ...
    effects: [
      {
        name: "Staff of Sneaky Stealin'",
        desc:
          'Add 1 to casting and unbinding rolls for the bearer for each enemy WIZARD within 12" of the bearer. In addition, add 1 to casting and unbinding rolls for the bearer for each enemy PSYCHIC with an artefact of power within 12" of the bearer.',
        when: PSYCHIC_PHASE,
      },
    ],
  },
    ...
    effects: [
      {
        name: "Nibblas 'Itty Ring",
        desc:
          'Once per battle, at the start of a FIGHT phase, you can pick 1 enemy unit within 3" of the bearer and roll a dice. On a 1 there is no effect. On a 2-5 that enemy unit suffers D3 mortal wounds. On a 6, that enemy unit suffer D6 mortal wounds.',
        when: START_OF_FIGHT_PHASE,
      },
    ],
  },
    ...
    effects: [
      {
        name: 'Earskuttla',
        desc:
          'Once per battle, at the start of a FIGHT phase, you can pick 1 enemy WIZARD within 3", and roll a dice. On a 2+, that enemy WIZARD suffers D3 mortal wounds. In addition, for the rest of the battle, subtract 1 from casting and unbinding rolls for that WIZARD for each mortal wound that was inflicted.',
        when: START_OF_FIGHT_PHASE,
      },
    ],
  },
    ...
    effects: [
      {
        name: 'Pet Gribbly',
        desc:
          'If an enemy unit attacks the bearer in the FIGHT phase before the bearer has been selected to fight in that FIGHT phase, then the enemy unit suffers D3 mortal wounds after all of its attacks have been resolved.',
        when: FIGHT_PHASE,
      },
    ],
  },
